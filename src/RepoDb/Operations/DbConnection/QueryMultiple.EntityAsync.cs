...
public static partial class DbConnectionExtension
{
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>A tuple of 4 enumerable target data entity types.</returns>
    internal static ValueTask<Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>>> QueryMultipleInternalAsync<T1, T2, T3, T4>(this IDbConnection connection,
        QueryGroup? where1,
        QueryGroup? where2,
        QueryGroup? where3,
        QueryGroup? where4,
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>A tuple of 5 enumerable target data entity types.</returns>
    internal static ValueTask<Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>>> QueryMultipleInternalAsync<T1, T2, T3, T4, T5>(this IDbConnection connection,
        QueryGroup? where1,
        QueryGroup? where2,
        QueryGroup? where3,
        QueryGroup? where4,
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>A tuple of 6 enumerable target data entity types.</returns>
    internal static ValueTask<Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>, IEnumerable<T6>>> QueryMultipleInternalAsync<T1, T2, T3, T4, T5, T6>(this IDbConnection connection,
        QueryGroup? where1,
        QueryGroup? where2,
        QueryGroup? where3,
        QueryGroup? where4,
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>A tuple of 7 enumerable target data entity types.</returns>
    internal static ValueTask<Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>, IEnumerable<T6>, IEnumerable<T7>>> QueryMultipleInternalAsync<T1, T2, T3, T4, T5, T6, T7>(this IDbConnection connection,
        QueryGroup? where1,
        QueryGroup? where2,
        QueryGroup? where3,
        QueryGroup? where4,
