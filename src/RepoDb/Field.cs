...
public class Field : IEquatable<Field>
{
    ...
    public static FieldSet<TEntity> Parse<TEntity>(Expression<Func<TEntity, object?>> expression)
        where TEntity : class =>
    ...
    /// <param name="expression">The expression to be parsed.</param>
    /// <returns>An enumerable list of <see cref="Field"/> objects.</returns>
    public static FieldSet<TEntity> Parse<TEntity, TResult>(Expression<Func<TEntity, TResult?>> expression)
        where TEntity : class
    {
