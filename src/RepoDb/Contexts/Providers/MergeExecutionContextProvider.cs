...
internal static class MergeExecutionContextProvider
{
    ...
    {
        var key = (entityType, tableName, qualifiers, fields, noUpdateFields, hints);
        ...
        return MergeExecutionContextCache.GetOrAdd(key, (_) => CreateInternal(entityType, connection, tableName, qualifiers, fields, noUpdateFields, hints, transaction, statementBuilder, dbFields));
    }
    ...
    private static MergeExecutionContext CreateInternal(Type entityType, IDbConnection connection, string tableName, FieldSet qualifiers, FieldSet fields, FieldSet? noUpdateFields, string? hints, IDbTransaction? transaction, IStatementBuilder? statementBuilder, DbFieldCollection dbFields)
    {
