...
public class UpdateTest
{
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaDataEntity()
    {
        ...
        // Act
        var result = await connection.UpdateAsync<SdsCompleteTable>(table, cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaExpression()
    {
        ...
        // Act
        var result = await connection.UpdateAsync<SdsCompleteTable>(table, e => e.Id == table.Id, cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaDynamic()
    {
        ...
        // Act
        var result = await connection.UpdateAsync<SdsCompleteTable>(table, new { table.Id }, cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaQueryField()
    {
        ...
        // Act
        var result = await connection.UpdateAsync<SdsCompleteTable>(table, new QueryField("Id", table.Id), cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaQueryFields()
    {
        ...
        // Act
        var result = await connection.UpdateAsync<SdsCompleteTable>(table, queryFields, cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaQueryGroup()
    {
        ...
        // Act
        var result = await connection.UpdateAsync<SdsCompleteTable>(table, queryGroup, cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaTableNameViaDataEntity()
    {
        ...
        // Act
        var result = await connection.UpdateAsync(ClassMappedNameCache.Get<SdsCompleteTable>(), table, cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaTableNameViaDynamic()
    {
        ...
        // Act
        var result = await connection.UpdateAsync(ClassMappedNameCache.Get<SdsCompleteTable>(), table, new { table.Id }, cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaTableNameViaQueryField()
    {
        ...
        // Act
        var result = await connection.UpdateAsync(ClassMappedNameCache.Get<SdsCompleteTable>(), table, new QueryField("Id", table.Id), cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaTableNameViaQueryFields()
    {
        ...
        // Act
        var result = await connection.UpdateAsync(ClassMappedNameCache.Get<SdsCompleteTable>(), table, queryFields, cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSqLiteConnectionUpdateAsyncViaTableNameViaQueryGroup()
    {
        ...
        // Act
        var result = await connection.UpdateAsync(ClassMappedNameCache.Get<SdsCompleteTable>(), table, queryGroup, cancellationToken: TestContext.CancellationToken);
