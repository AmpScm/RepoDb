...
public class InsertAllTest
{
    ...
    public async Task TestSQLiteConnectionInsertAllAsyncForIdentity()
    {
        ...
        // Act
        var result = await connection.InsertAllAsync<SdsCompleteTable>(tables, cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSQLiteConnectionInsertAllAsyncForNonIdentity()
    {
        ...
        // Act
        var result = await connection.InsertAllAsync<SdsNonIdentityCompleteTable>(tables, cancellationToken: TestContext.CancellationToken);
