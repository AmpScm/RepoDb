...
public class MergeAllTest
{
    ...
    public async Task TestSQLiteConnectionMergeAllAsyncForIdentityForEmptyTable()
    {
        ...
        // Act
        var result = await connection.MergeAllAsync<SdsCompleteTable>(tables, cancellationToken: TestContext.CancellationToken);
    ...
    public async Task TestSQLiteConnectionMergeAllAsyncForNonIdentityForEmptyTable()
    {
        ...
        // Act
        var result = await connection.MergeAllAsync<SdsNonIdentityCompleteTable>(tables, cancellationToken: TestContext.CancellationToken);
